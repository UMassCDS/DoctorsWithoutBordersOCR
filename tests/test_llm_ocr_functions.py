...
def assert_color_within_tolerance(color1, color2, tolerance=1):
    """
    Assert that two colors are within a given tolerance.

    :param color1: The first color as an (R, G, B) tuple.
    :param color2: The second color as an (R, G, B) tuple.
    :param tolerance: The tolerance for each color component.
    """
